...
function showCombos3()
{
	...
	$.ajax({
		type: "POST",
		url: appPath+"msd/levelcombos2_all_levels_action.php",
		...
		success: function(data){
				...
				$('#warehouse').html(data);
                                ...
                                $('#warehouse').removeClass('input-large').addClass('input-large');
		}		
	});
}
...
function showCombos2()
{
	if ( $('#office').val() > 1 )
	{
		...
		$.ajax({
			type: "POST",
			url: appPath+"msd/bar_combos_action_2.php",
...
function showCombos()
{
	...
	$('#div_combo2').hide();
	$('#wh_combo').hide();
        var show_national = $('#show_national').val();
	$.ajax({
		type: "POST",
		url: appPath+"msd/bar_combos_action.php",
		data: {office: $('#office').val(),mainstkid:$('#mainstkid').val(),show_national:show_national},
		dataType: 'html',
		success: function(data){
			$('#loader').hide();
			var val1 = $('#office').val();
