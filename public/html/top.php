    ...
    <div class="header navbar"> 
        ...
        <div class="header-inner"> 
            ...
            <ul class="nav navbar-nav pull-right">
                <?php
                if(isset($_SESSION['user_warehouse']) && $_SESSION['user_stakeholder']!=1222) {
            ?>
                <!--<li>
            ...
            <?php }
            if ($_SESSION['user_warehouse'] != 95502 && $_SESSION['user_role']!=77 && $_SESSION['user_warehouse'] != 96584 && $_SESSION['user_warehouse'] != 96596 && $_SESSION['user_stakeholder']!=1222) {
            ?>
