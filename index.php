			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="https://pbs.twimg.com/profile_images/1204057729033216001/yT086miO_400x400.jpg" class="brand_logo" alt="Logo">
					</div>
				</div>
                ...
                <form name="LogIn" id="LogIn" action="application/default/index.php" method="post" onsubmit="return CheckUser()" role="form">
						<div class="input-group mb-3">
							...
							<input type="text" name="login" id="login" class="form-control input_user" value="" placeholder="username">
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have a password? <a href="mailto:support@lmis.gov.pk" class="ml-2" style="color:white;">Contact us</a>
					</div>
				</div>
			</div>
		</div>
