                                                        ...
                                                        <div class="" id="tab11">
                                                            <div class="portlet  ">
                                                                <div class="portlet-body">
                                                                    ...
                                                                    <!--<input multiple class="btn green" type="file" required name="fileToUpload[]" id="fileToUpload" accept=".xls,.xlsx,.jpeg, .jpg,.png,.pdf,.doc,.docx, application/vnd.openxmlformats-officedocument.wordprocessingml.document, application/msword, application/pdf, image/png,image/jpeg,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" >-->
