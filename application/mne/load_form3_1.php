...
$parent_id = $_POST['parent_id'];
 ...
 $barray = $_POST['sel_pr'];
    ...
    if (isset($barray)) {
        $b = implode(",", $barray);
    $where = "AND itminfo_tab.itm_id IN ($b)";}
    else{
        $where = '1<>1';
        $b = '';
    }
...
<form method="POST" id="form_3_exe">
    ...
    <table class="table table-bordered">
        ...
        <tr class="form-group">
            ...
            <th colspan="8"><p>For items D-K, enter 1 if the data for the tracer product has been entered on the monitoring tool correctly within the last month. Enter 0 if data element is missing, blank, or entered incorrectly. Adjust the data elements as needed based on the country's stock report or ordering tool. </p></th>
        </tr>
        <tr class="form-group">
        ...
        while ($row = $query->fetch_assoc()) {
            ...
            <tr class="form-group">
                ...
                <td class="" name="<?php echo "form3_" . $pk_id . "_P"; ?>" id=" <?php echo "form3_" . $pk_id . "_P"; ?>" ><?php echo $product_name; ?></td>
                <td><input type="checkbox" style="margin-left: 30px;"  name="<?php echo "form3_" . $pk_id . "_A"; ?>" id=" <?php echo "form3_" . $pk_id . "_A"; ?>" <?php
                    if ($row_1['offered'] == 1) {
                ...
                <td > 
                    ...
                    ?>
                    <select  class="form-control"  name="<?php echo "form3_" . $pk_id . "_B[]"; ?>" id=" <?php echo "form3_" . $pk_id . "_B"; ?>"  multiple>
                        <?php
                ...
                <td><input type="checkbox" style="margin-left: 40px;" name="<?php echo "form3_" . $pk_id . "_C"; ?>" id=" <?php echo "form3_" . $pk_id . "_C"; ?>" <?php
                    if ($row_1['tools_available'] == 1) {
                        echo 'checked="checked"';
                    }
                    ?>></td>
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_D"; ?>" id=" <?php echo "form3_" . $pk_id . "_D"; ?>">
                        <option value="na" <?php
                        if ($row_1['s_o_h'] == 'na') {
                ...
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_E"; ?>" id=" <?php echo "form3_" . $pk_id . "_E"; ?>">
                        <option value="na" <?php
                ...
                <td><select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_F"; ?>" id=" <?php echo "form3_" . $pk_id . "_F"; ?>">
                        <option value="na" <?php
                ...
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_G"; ?>" id=" <?php echo "form3_" . $pk_id . "_G"; ?>">
                        <option value="na" <?php
                        if ($row_1['receive'] == 'na') {
                            echo 'selected="selected"';
                        }
                ...
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_H"; ?>" id=" <?php echo "form3_" . $pk_id . "_H"; ?>"> 
                        <option value="na" <?php
                        if ($row_1['issue'] == 'na') {
                            echo 'selected="selected"';
                        }
                ...
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_I"; ?>" id=" <?php echo "form3_" . $pk_id . "I"; ?>">
                        <option value="na" <?php
                        if ($row_1['a_m_c'] == 'na') {
                            echo 'selected="selected"';
                        }
                ...
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_J"; ?>" id=" <?php echo "form3_" . $pk_id . "_J"; ?>">
                        <option value="na" <?php
                        if ($row_1['min'] == 'na') {
                            echo 'selected="selected"';
                        }
                ...
                <td>
                    <select class="form-control" style="padding:0px !important" name="<?php echo "form3_" . $pk_id . "_K"; ?>" id=" <?php echo "form3_" . $pk_id . "_K"; ?>">
                        <option value="na" <?php
                        if ($row_1['max'] == 'na') {
                            echo 'selected="selected"';
                        }
        ...
        <tr >
            <td colspan="12">
                ...
                <textarea class="form-control"  name="form3_comment" id="form3_comment"></textarea>
            </td>
        </tr>
    </table>
    <a class="btn btn-default pull-right" onclick="form3_exe();" >Submit</a><br><br><br><br><br><br>
</form>
