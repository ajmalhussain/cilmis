...
<form method="POST" id="form2_to3_execution"> 
    <table border="2px" class="table table-bordered">
        ...
        <tr class="form-group">
             <?php
                    ...
                    mne_basic_followup
                    WHERE
                    mne_basic_followup.item_group_id = 'to3'
            ...
            <td>
                ...
                <input type="hidden" class="form-control" id="form2_item_group" name="form2_item_group" value="to3" >
            </td>
            <td> 

                <textarea class="form-control" id="<?php echo "form2_".$pk_id."_M" ;?>" name="<?php echo "form2_".$pk_id."_M" ;?>"  ><?php echo $row_1['actions']; ?></textarea>
            </td>
            <td> 
                <textarea class="form-control" id="<?php echo "form2_".$pk_id."_N" ;?>" name="<?php echo "form2_".$pk_id."_N" ;?>"  ><?php echo $row_1['support']; ?></textarea>
            </td>
            <td> 
                <textarea class="form-control" id="<?php echo "form2_".$pk_id."_O" ;?>" name="<?php echo "form2_".$pk_id."_O" ;?>" ><?php echo $row_1['responsible']; ?></textarea>
            </td>
            <td> 
                <textarea class="form-control" id="<?php echo "form2_".$pk_id."_P" ;?>" name="<?php echo "form2_".$pk_id."_P" ;?>" ><?php echo $row_1['completion_date']; ?></textarea>
            </td>
            <td> 
    ...
    <a class="btn btn-default pull-right" name="submit2" onclick="form2_to3_exe();">Submit</a><br><br><br><br><br><br>
