...
//Checking Do
                ...
                LIMIT 1";
                    ...
                    if ($_SESSION['user_role'] == 65) {
                        $wh_id_id = $_SESSION['user_warehouse'];
                        echo "<div style=text-align:right><a href='print_consumption_form.php?wh=$wh_id_id'><button type='button' class='btn btn-primary'>Print empty form</button></a></div>";
                    }
