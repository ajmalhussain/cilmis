                                                    ...
                                                    if(!empty($sources)){
                                                        ...
                                                        foreach ($sources as $key => $rowsrc) {
                                                            ...
                                                            <td><input class="form-control input-sm text-right FLDSrcs<?php echo $rsRow1['itm_id']; ?>" <?php
                                                                ...
                                                                $sources_rcvings+=$this_value;
                                                                ?> autocomplete="off"  type="text" name="FLDSrcs<?php echo $rsRow1['itm_id']; ?>[<?php echo $key; ?>]" id="<?php echo $rowsrc . $rsRow1['itm_id']; ?>" size="8" maxlength="10"  value="<?php echo $this_value; ?>" onKeyUp="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                    <?php                               }//end of foreach sources
                                                    $rsRow2['received_balance'] = $sources_rcvings;    
                                                    $rsRow2['closing_balance'] = $rsRow2['opening_balance'] + $sources_rcvings + $rsRow2['adjustment_positive'] - $rsRow2['issue_balance'] - $rsRow2['adjustment_negative'];
                                                        
                                                    }//end of if not empty sources
                                                    else{
                                                        if($readonly_for_im){
                                                            $this_rcv = ((!empty($rcvd_array[$rsRow1['itm_id']])) ? $rcvd_array[$rsRow1['itm_id']] : '0');
                                                            $rsRow2['received_balance'] = $this_rcv;
                                                            
                                                            $rsRow2['closing_balance'] = $rsRow2['opening_balance'] + $this_rcv + $rsRow2['adjustment_positive'] - $rsRow2['issue_balance'] - $rsRow2['adjustment_negative'];
                                                        } 
                                                    }
