...
<form name="frmF7" id="frmF7" method="post">
    <div class="row">
        <div class="col-md-12">
            ...
            <table width="100%" align="center" class="table table-bordered">
                ...
                if ($_SESSION['user_role'] == 65 || $_SESSION['user_role'] == 104) {
	...
	CONCAT(
		...
		' (',
		IFNULL(itminfo_tab.generic_name,''),
		')'
	) itm_name FROM itminfo_tab INNER JOIN stock_batch ON itminfo_tab.itm_id = stock_batch.item_id WHERE stock_batch.wh_id = $sess_wh_id ORDER BY itminfo_tab.itm_name");
                } else {
                    $rsTemp1 = mysql_query("SELECT * FROM `itminfo_tab` WHERE `itm_status`=1 AND `itm_id` IN (SELECT `Stk_item` FROM `stakeholder_item` WHERE `stkid` =$stkid) AND itminfo_tab.itm_category IN ($item_category_id) ORDER BY itm_category,`frmindex`,itm_name ");
                }
                //query
                ...
                while ($rsRow1 = mysql_fetch_array($rsTemp1)) {
                    if (!empty($result_province['prov_id']) && $result_province['prov_id'] != 2) {
                        if ($rsRow1['itm_id'] == 34)
                            continue;
                    }
	...
	stock_sources_data.hf_data_id = $hf_data_id";
                    ...
                    if ($isNewRpt == 1) {
                        ...
                        <tr>
                            ...
                            <td><input class="form-control input-sm text-right" autocomplete="off" type="text" name="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" id="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $wh_adja; ?>" onfocusout="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                            <td><input class="form-control input-sm text-right" autocomplete="off" type="text" name="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" id="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $wh_adjb; ?>" onfocusout="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
        ...
        <?php } ?>
                            ...
                            <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" id="FLDReturnTo<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['adjustment_positive']; ?>" onfocusout="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
                            <td><input class="form-control input-sm text-right" autocomplete="off"  type="text" name="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" id="FLDUnusable<?php echo $rsRow1['itm_id']; ?>" size="8" maxlength="10" value="<?php echo $rsRow2['adjustment_negative']; ?>" onfocusout="cal_balance('<?php echo $rsRow1['itm_id']; ?>');"></td>
