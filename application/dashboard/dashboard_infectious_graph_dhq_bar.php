...
<div class="widget widget-tabs" style="border:0px;">
    <div class="widget-body" id="a2" style='background-color: white;'>
        ...
        <h3 style="text-align: center;">DHQ Comparison</h3>
        <?php
        $stock_arr = array();
...
//            print_r('into categoryyyy');exit;
            $xmlstore .= "<category label='$dist_name' />";
        }
//        print_r($dist_arr_name);exit;
        $xmlstore .= "</categories>";
        ...
        echo renderChart(PUBLIC_URL . "FusionCharts/Charts/MSColumn2D.swf", "", $xmlstore, 'dhq_im_bar', '100%', 300, false, false);
        ?>
