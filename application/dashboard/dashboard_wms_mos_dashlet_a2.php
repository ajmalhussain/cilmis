...
//        $xmlstore .= '  </dataset>';
       ...
       foreach ($wh_arr as $id => $name) {
            $xmlstore .= "<set  value='". number_format($stock_arr[$id]['mos'],2) . "' link=\"P-detailsWin,width=900,height=600,toolbar=no,scrollbars=yes, resizable=no-dashboard_wms_mos_drilldown.php?prov_sel=$province&from_date=$from_date&level=3&wh_id=$id&product=$product_array\"/>";
        }
        $xmlstore .= '  </dataset>';
