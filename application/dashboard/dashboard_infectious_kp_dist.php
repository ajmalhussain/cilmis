            ...
            <div class="page-content">
                    ...
                    <div class="col-md-12">
                        <div class="tabsbar">
                            <ul>
                                ...
                                <li class="active"><a href="#"> <b>District Store Stock Status</b></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-left:0px;margin-right: 0px;" >
                    <div class="col-md-6 my_dash_cols panel panel-default" >
                        <div class="col-md-12 my_dashlets panel-body" >
                            <div class="dashlet_graph" id="ss_i1" href='dashboard_infectious_dashlet_dist_i1.php'>
                                Please press Go button to load data
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 my_dash_cols panel panel-default" >
                        <div class="col-md-12 my_dashlets panel-body" >
                            <div class="dashlet_graph" id="ss_i2" href='dashboard_infectious_dashlet_dist_i2.php'>
                                Please press Go button to load data
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-left:0px;margin-right: 0px;" >
                    <div class="col-md-6 my_dash_cols panel panel-default" >
                        <div class="col-md-12 my_dashlets panel-body" >
                            <div class="dashlet_graph" id="ss_i3" href='dashboard_infectious_dashlet_dist_i3.php'>
                                Please press Go button to load data
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 my_dash_cols panel panel-default" >
                        <div class="col-md-12 my_dashlets panel-body" >
                            <div class="dashlet_graph" id="ss_i4" href='dashboard_infectious_dashlet_dist_i4.php'>
                                Please press Go button to load data
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
                                    $(document).on('click', '#submit_btn', function () {
                                        if ($("#prov_sel").val() == '') {
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: 'dashboard_infectious_dashlet_dist_i1.php',
                                                data: form_data,
                                                dataType: 'html',
                                                success: function (data) {
                                                    $("#ss_i1").html(data);
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: 'dashboard_infectious_dashlet_dist_i2.php',
                                                data: form_data,
                                                dataType: 'html',
                                                success: function (data) {
                                                    $("#ss_i2").html(data);
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: 'dashboard_infectious_dashlet_dist_i3.php',
                                                data: form_data,
                                                dataType: 'html',
                                                success: function (data) {
                                                    $("#ss_i3").html(data);
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: 'dashboard_infectious_dashlet_dist_i4.php',
                                                data: form_data,
                                                dataType: 'html',
                                                success: function (data) {
                                                    $("#ss_i4").html(data);
