...
<!--                    <img src="maintenance.jpg" >-->
                    <div class="row">
                                <div class="col-md-12 center">
                                        <div class="alert alert-error center h2" style="height:150px">
                                                <div class="details center">
                                                        <div class="number center" id="general_av_dist">Executive Dashboard is Under Maintenance</div>
                                                        <br/>
                                                        <div class="desc center" style="font-size:20px;">We are working on improving your experience . </div>
                                                        <div class="desc center" style="font-size:20px;">Sorry for inconvenience. </div>
                                                </div>
                                        </div>
                                   </div> 
                           </div>
                    ...
                    ?>
                      ...
                      <div class="row hide_divs" >
                            <div class="col-md-12">
                                <h3 class="page-title row-br-b-wp center"> <?php echo $prov_name;?><?=(!empty($district)?' - '.$dist_name:'')?> - Executive Dashboard - <?php echo date('M-Y',strtotime($fromDate)); ?> 
