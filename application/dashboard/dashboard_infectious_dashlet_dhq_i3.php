...
<div class="widget widget-tabs" style="border:0px;">
    <div class="widget-body" id="a2" style='background-color: white;'>
        ...
        <h3 style="text-align: center;">Swat DHQ Stock Status</h3>
        <?php
        $stock_arr = array();
        $count = 1;
        $counter = 0;
...
//        exit;
        ...
        echo renderChart(PUBLIC_URL . "FusionCharts/Charts/Doughnut2D.swf", "", $xmlstore, 'dhq_swat', '100%', 300, false, false);
        ?>
