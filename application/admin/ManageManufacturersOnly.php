...
<body class="page-header-fixed page-quick-sidebar-over-content" onLoad="doInitGrid()">
                                            ...
                                            <div class="col-md-12 right">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <input type="hidden" name="redirect_to" value="ManageManufacturersOnly" />
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-head">
                                ...
                                ?>
                                <h3 class="heading">All Manufacturer</h3>
                            </div>
                            <div class="widget-body">
    ...
    <script type="text/javascript">
        ...
        function doInitGrid() {
            ...
            mygrid.setHeader("<span title='Serial Number'>Sr. No.</span>,<span title='Manufacturer Name'>Manufacturer</span>,<span title='Manufacturer Level'>Manufacturer Level</span>,<span title='Type'>Type</span>,#cspan,#cspan");
