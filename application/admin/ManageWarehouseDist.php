 ...
 * Delete
 */
// NOTE ::: Delete functionality is disabled , due to security concern.
//  You may mark it inactive.
//
// allowIM
if ($strDo == "im_allowed") {
...
if ($_SESSION['user_id'] == 1 OR $_SESSION['user_id'] == 2042) {
    $max = 99;
} else {
    $max = 2;
}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body">
                                <form method="post" action="ManagewarehouseDistAction.php" name="managewarehouses" id="managewarehouses">
                                    <div class="row">
                                        <div class="col-md-12">
...
<?php } ?>
        ...
        {
            var pid = <?php echo $_SESSION['user_stakeholder']; ?>;
            if (pid == '')
            {
        ...
        var flAuto = false;
        function doOnLoad() {
            var dist = <?php echo $_SESSION['user_district']; ?>;
            ...
            mygrid.loadXML("xml_warehouse.php?dist=" + dist + "&un=" + Date.parse(new Date()));
        }
        ...
        function reloadGrid() {
            var prov = <?php echo $_SESSION['user_province']; ?>;
            var dist = <?php echo $_SESSION['user_district']; ?>;
            var stk = <?php echo $_SESSION['user_stakeholder']; ?>;
