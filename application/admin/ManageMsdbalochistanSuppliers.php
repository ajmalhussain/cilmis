...
if ($strDo == "Delete") {
    ...
    echo '<script>window.location="ManageSuppliers1.php"</script>';
    exit;
}
//unset pk_id
...
<body class="page-header-fixed page-quick-sidebar-over-content" onLoad="doInitGrid()">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">Supplier Management</h3>
                        <div class="widget" data-toggle="collapse-widget">
                            <div class="widget-head">
                                <h3 class="heading"><?php echo $strDo; ?> Supplier</h3>
                            </div>
                            <div class="widget-body">
                                <form method="post" action="ManageMsdbalochistanSuppliers_prov_action.php" id="Managestakeholdersaction">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                             ...
                                             <div class="col-md-3">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input name="cpname" value="<?= $cpname; ?>" class="form-control input-medium" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
											<div class="col-md-3">
                                                 <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input name="cnnumber" value="<?= $cnnumber; ?>" class="form-control input-medium" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                               <div class="control-group">
													 ...
													 <div class="controls">
													<input type="email" class="form-control input-medium" id="email" value="<?= $email; ?>" name="email" autocomplete="off">
                                                    </div>
												</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label>GSTN#</label>
                                                    <div class="controls">
                                                        <input name="gstn" value="<?= $gstn; ?>" class="form-control input-medium" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-md-3">
                                                <div class="control-group">
                                                    <label>NTN#</label>
                                                    <div class="controls">
                                                        <input name="ntn" value="<?= $ntn; ?>" class="form-control input-medium" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
											 <div class="col-md-3">
										   <div class="control-group">
                                                    <label>Address</label>
                                                    <div class="controls">
                                                        <input name="address" value="<?= $address; ?>" class="form-control input-medium" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12 right">
                                                <div class="control-group">
                                                    <label>&nbsp;</label>
                                                    <div class="controls">
                                                        <input type="hidden" name="redirect_to" value="ManageMsdbalochistanSuppliers" />
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-head">
                                ...
                                ?>
                                <h3 class="heading">All Suppliers</h3>
                            </div>
                            <div class="widget-body">
    ...
    <script type="text/javascript">
        function editFunction(val) {
            window.location = "ManageMsdbalochistanSuppliers.php?Do=Edit&Id=" + val;
        }
        function delFunction(val) {
            if (confirm("Are you sure you want to delete the record?")) {
                window.location = "ManageMsdbalochistanSuppliers.php?Do=Delete&Id=" + val;
            }
        }
        var mygrid;
        //Initializing grid
        function doInitGrid() {
            ...
            mygrid.setHeader("<span title='Serial Number'>Sr. No.</span>,<span title='Supplier Name'>Supplier Source</span>,<span title='Stakeholder Level'>Level</span>,<span title='Type'>Type</span>,<span title='Use this column to perform the desired operation'>Actions</span>,#cspan");
