    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">Reporting Stakeholders against their Approving Stakeholders (ONLY relevant to REQUISITIONS FLOW)</h3>
                        
                        <h5 class="col-md-12  label label-danger center">Do NOT Edit if you dont know what you are doing !</h5>
<?php if ($strDo == 'Edit') : ?>
                        <?php
