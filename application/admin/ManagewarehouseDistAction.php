...
if (isset($_REQUEST['im_date']) && !empty($_REQUEST['im_date'])) {
    //reporting start month
    $im_date = $_REQUEST['im_date'];
}
...
if (!empty($_REQUEST['is_allowed_im'])) {
...
//stkid
$objwarehouse->m_stkid = $_SESSION['user_stakeholder'];
//stkofficeid
$objwarehouse->m_stkofficeid = $stkofficeid;
//prov_id
$objwarehouse->m_prov_id = $_SESSION['user_province'];
//dist_id
$objwarehouse->m_dist_id = $_SESSION['user_district'];
//wh_name
...
$objwarehouse->im_date = $im_date . '-01';
...
$objwarehouse->user_id = $_SESSION['user_id'];
$objwarehouse->parent_id = $_SESSION['user_warehouse'];
//echo '<pre>';print_r($objwarehouse);
...
header("location:ManageWarehouseDist.php");
exit;
