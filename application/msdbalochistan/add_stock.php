...
//get location name
$getLocationName = mysql_query("select location_name,loc_description from placement_config where pk_id=" . $loc_id) or die(mysql_error());
//row location
                    ...
                    <div class="col-md-12"> 
                        ...
                        <div class="widget"> 
                            ...
                            <div class="widget-head">
                                <h3 class="heading"> Place stock from received list to Location: <?php echo (!empty($rowLocation['loc_description'])?$rowLocation['loc_description'].'  ('.$rowLocation['location_name'].')':$rowLocation['location_name']) ?> </h3>
                            </div>
                            <!-- // Widget heading END -->
