                                                ...
                                                <div class="controls">
                                                    <select class="form-control input-small" name="area" id="area" required>
                                                        ...
                                                        while ($rowArea = mysql_fetch_assoc($getArea)) {
                                                            ...
                                                            $msd_val =  array_search($rowArea['list_value'], $alphabet);
                                                            $msd_val += 1;
                                                            //populate area combo
                                                            ?>
                                                        ...
                                                        if ($hit == 0) {
                                                            ...
                                                            foreach ($rowStatus as $row):
                                                                ...
                                                                if(!empty($row['loc_description'])){
                                                                    $manual_names[$row['location_name']] = $row['loc_description'];
                                                                }
                                                                //row
                                                                $row1 = (int) $row['myrow'];
                                                                //rack
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td title="Used : <?=(!empty($used_per1)?$used_per1:0)?>%"  style="background-color: <?php echo $color1; ?>; border:1px solid;" height="<?php echo $total_per1; ?>%">
                                                                                                <?php if (!empty($loc1) && $total_per1 != 0) { ?>
                                                                                                    <a itemid="<?php echo $loc1; ?>" class="btn product-location  " href="<?php echo $url; ?>" style="color:black"> <?php echo (isset($manual_names[$l1])?$manual_names[$l1]:$l1); ?></a>
                                                                                                    <?php
                                                                                                }
                                                                                                ?></td>
                                                                                        </tr>
