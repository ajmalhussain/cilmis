...
$items = $objManageItem->GetAllProductsOfcLMIS();
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                                                ...
                                                                <select name="product" id="product"  class="input-large  select2me">
                                                                    ...
                                                                    if (mysql_num_rows($items) > 0) {
                                                                        ...
                                                                        while ($row = mysql_fetch_object($items)) {
                                                                            ...
                                                                            ?>
                                                                            <option value="<?php echo $row->itm_id; ?>" <?php if ($row->itm_id == $product) { ?>selected=""<?php } ?>><?php echo $row->itm_name . ' ' . ((!empty($row->generic_name) && $row->generic_name != 'NULL') ? '[' . $row->generic_name . ']' : ''); ?></option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="control-group">
                                                                    <label class="control-label" for="item_code"> Barcode </label>
                                                                    <div class="controls">
                                                                        <input class="form-control input-medium" id="item_code" name="item_code" type="text"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                        </div>
                                            ...
                                            <div class="col-md-6" id="vaccine-detail" <?php if ($flag == true) { ?> style="display:block;" <?php } else { ?>style="display:none;" <?php } ?>> 
                                                ...
                                                ?>
                                                <div class="widget row-fluid" data-toggle="collapse-widget"  id="batch_detail_ajax" style="height:180px;">
                                                    <?php
                                                    if ($result) {
                                                        ?>
                                                        <!-- Widget heading -->
...
//include footer
    ...
    <script src="<?php echo PUBLIC_URL; ?>js/barcode/barcode_splitter_batch.js"></script>
