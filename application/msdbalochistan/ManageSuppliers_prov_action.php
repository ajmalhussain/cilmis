...
if ($strDo == "Add") {
    ...
    $strSql = "INSERT INTO  stakeholder (stkname,stkorder,ParentID,stk_type_id,lvl,MainStakeholder) VALUES('" . $objstk->m_stkname . "'," . $objstk->m_stkorder . "," . $objstk->m_ParentID . "," . $objstk->m_stk_type_id . "," . $objstk->m_lvl . "," . $objstk->m_MainStakeholder . ")";
//echo $strSql;exit;
