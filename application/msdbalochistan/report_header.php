...
<div style="line-height:1;">
    ...
    <img src="<?php echo PUBLIC_URL;?>images/msd_balochistan.png" />
    </div>
    <div id="report_type" style="float:left; width:440px; text-align:center;">
        
        <span style="line-height:20px"><b>Department Of Health</b></span><br/>
        <span style="line-height:20px"><b>GOVERNMENT OF BALOCHISTAN</b></span><br/>
        <span style="line-height:20px"><b>MEDICAL STORE DEPOT</b></span><br/>
        
        <span style="line-height:15px"><b>Store: </b><?php echo $whName['wh_name'];?></span>
        <hr style="margin:3px 10px;" />
        <p><b><?php echo $rptName;?>  </br> As on: <?php echo date('d-M-Y');?></b>
        </p>
    </div>
</div>
