...
//check receive from supplier
if (isset($_REQUEST['receive_from_supplier']) && !empty($_REQUEST['receive_from_supplier'])) {
    //get receive from
    $receive_from_supplier = $_REQUEST['receive_from_supplier'];
}
//check product
...
if (empty($trans_no) && $receive_from>0) {
    ...
    $objStockMaster->WHIDFromSupplier = $receive_from_supplier;
    //to warehouse
