...
<div id="content_print">
	...
	?>
        ...
        <div style="clear:both;">
            <span style="float:left;"><b>Authority Letter No.:</b> <?php echo $tran_ref; ?></span>
        ...
        <div style="width:100%; clear:both;">
            <table width="48%" cellpadding="5" style="float:left; border:0px solid #E5E5E5 !important; border-collapse:collapse; margin-top:10px;">
                <tr>
                    <td><b>Checked / Verified by</b> - Name: ________________________________________</td>
                </tr>
                <tr>
                    <td>Signature: ________________________________________</td>
                </tr>
                <tr>
                    <td><b>Pharmacist</b> Government MSD Lahore</td>
                </tr>
                <tr>
                    <td>Signature: ________________________________________</td>
                </tr>
                <tr>
                    <td><b>Depot Manager</b> Government MSD Lahore</td>
                </tr>
                <tr>
                    <td>Signature: ________________________________________</td>
                </tr>
