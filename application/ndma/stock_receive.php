                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="searchby" id="searchby" class="form-control input-medium">
                                                            ...
                                                            <option value="3" <?php if ($searchby == 3) { ?> selected <?php } ?>>Batch No./Lot No.</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        if ($result != FALSE) {
                                            ...
                                            while ($row = mysql_fetch_object($result)) {
                                                ...
                                                <tr class="gradeX" style="background-color:<?php echo $row->field_color; ?> !important" id="<?php echo $row->PkDetailID; ?>">
                                                    ...
                                                    <?php
                                                    if ($_SESSION['user_id'] == $row->CreatedBy ) {
...
//                                                        print_r($qry);exit;
                                                        ...
                                                        if (!$qryRes) {
                                                            echo "<a href='new_receive_editable.php?edit_voucher_master_id=$row->PkStockID&edit_id=$row->PkDetailID'>Edit</a>";
                                                        } 
                                                    }
                                                    ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                       ...
                                                       href="<?php echo APP_URL . 'ndma/attachments/' .$row->attachment_name;?>">Download</a>
                                                         <?php } ?>
                                                </td>
                                                </tr>
                                                <?php
