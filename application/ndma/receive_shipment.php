...
$strSql = " SELECT
            ...
            WHERE
            tbl_stock_master.shipment_id =  '".$_REQUEST['shipment_id']."' AND 
            tbl_stock_master.po_detail =  '".$_REQUEST['detail_id']."' ";
...
if (isset($_REQUEST['shipment_id'])) {
    ...
    $qry = "SELECT
            ...
            WHERE
                purchase_order_product_details.pk_id = '".$det_id."' ";
//    echo $qry;
    $res = mysql_query($qry);
    $shipment_detail = mysql_fetch_assoc($res);
//    $shipment_detail = $objPurchaseOrder->get_PO_by_id($det_id);
    
    
    $TranRef        = $shipment_detail['po_number'];
    $from_id        = $shipment_detail['funding_source'];
    $productID      = $shipment_detail['item_id'];
    $manufacturer   = $shipment_detail['manufacturer_id'];
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3" id="expiry_div">
                                                ...
                                                <div class="controls">
                                                    <input autocomplete="off" type="text" class="form-control input-medium readonly_cls" name="expiry_date" id="expiry_date"  required style="background:#FFF;"/>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="controls right">
                                                    ...
                                                    <input type="hidden" name="shipment_id" id="shipment_id" value="<?php echo $_REQUEST['shipment_id']; ?>" />
                                                    <input type="hidden" name="detail_id" id="detail_id" value="<?php echo $_REQUEST['detail_id']; ?>" />
...
<?php if (!empty($tempstocks) && mysql_num_rows($tempstocks) > 0) { ?>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysql_fetch_object($tempstocks)) {
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td class="center"><span data-toggle="notyfy" shipment_id="<?=$_REQUEST['shipment_id']?>" detail_id="<?=$_REQUEST['detail_id']?>" id="<?php echo $row->PkDetailID; ?>" data-type="confirm" data-layout="top"><img class="cursor" src="<?php echo PUBLIC_URL; ?>images/cross.gif" /></span></td>
                                                </tr>
                                                <?php
                                                $i++;
                                            }
    ...
    <script src="<?php echo PUBLIC_URL; ?>js/dataentry/po_receive.js"></script> 
