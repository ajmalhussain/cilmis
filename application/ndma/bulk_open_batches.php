...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    ?>
                                                    ...
                                                    <select name="product" id="product" required="true" class="input-medium select2me"  <?php if (!empty($open_form)){ echo 'readonly'; } ?>>
                                                        ...
                                                        if (mysql_num_rows($items) > 0) {
                                                            ...
                                                            while ($row = mysql_fetch_object($items)) {
                                                                ...
                                                                echo "<option value=" . $row->itm_id . " " . $sel . " >" . $row->itm_name . "".(!empty($row->generic_name)?'['.$row->generic_name.']':'')."</option>";
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="col-md-1" style="margin-top: 30px;" ><a class="btn btn-xs green " href="../admin/ManageItems_by_stk.php" target="_blank" ><i class="fa fa-plus"></i></a></div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-6" style="margin-top: 30px; "> 
                                                        <a class="btn btn-primary btn-sm alignvmiddle" style="" id="add_m_p"  onclick="javascript:void(0);" data-toggle="modal"  href="#modal-manufacturer">Add New Manuf</a> 
                                                        <?php if (!empty($open_form)) { ?>
                                                        <a href="" class="btn green btn-sm"  > Select Another Product </a>
                                                    <?php }else
                                                    {
                                                        ?>
                                                        <button type="submit" class="btn green btn-lg" id="open_form" name="open_form" value="open_form">Start OB</button>
                                                        <?php
                                                    }
                                                    ?>
                                                    </div>
