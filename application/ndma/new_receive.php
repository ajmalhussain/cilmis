                    ...
                    <div class="col-md-12">
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body">
                                <form method="POST" name="new_receive" id="new_receive" action="new_receive_action.php" enctype= "multipart/form-data">
                                    <!-- Row -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3"> 
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input class="form-control input-medium" id="receive_ref" name="receive_ref" type="text" value="<?php echo $TranRef; ?>" <?php if (!empty($TranRef)) { ?>disabled="" <?php } ?>/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="row">                                        
                                        ...
                                        <div class="col-md-3 hide">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <select name="source_type" id="source_type" required="true" class="form-control input-medium" <?php if(!empty($source_type)) echo 'disabled'; ?>>
                                                        <option value="">Select</option>
                                                        <option value="donation" <?php if($source_type=='donation') echo'selected="selected"';?>>Donation</option>
                                                        <option value="procurement" <?php if($source_type=='donation') echo'selected="selected"';?>>Procurement</option>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <select name="shipment_mode" id="shipment_mode" required="true" class="form-control input-medium" <?php if(!empty($shipment_mode)) echo 'disabled'; ?>>
                                                        <option value="">Select</option>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <select name="event" id="event" required="true" class="form-control input-medium" <?php if(!empty($event)) echo 'disabled'; ?>>
                                                        <option value="">Select</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
<!--                                            <div class="col-md-3">
                                                <label class="control-label" for="shelf_date"> Shelf Date<span class="red">*</span> </label>
                                                <div class="controls">
                                                    <input name="shelf_date" id="shelf_date" required="true" class="form-control input-medium">
                                                    ...
                                                    <select name="product" id="product" required="true" class="form-control1 input-medium select2me">
                                                        ...
                                                        if (mysql_num_rows($items) > 0) {
                                                            ...
                                                            while ($row = mysql_fetch_object($items)) {
                                                                ...
                                                                echo "<option value=" . $row->itm_id . " " . $sel . " >"
                                                                        .$row->itm_name.' '.((!empty($row->generic_name) && $row->generic_name!='NULL')?'['.$row->generic_name.']':'').''
                                                                        .((!empty($row->itm_des) && $row->itm_des!='NULL')?'('.$row->itm_des.')':'')
                                                                        ."</option>";
                                                            }
                                                        }
                                                        ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <input class="form-control input-medium" id="batch" name="batch" type="text" required value="NA"/>
                                                </div>
                                            </div>
                                            <!-- div class="col-md-3">
                                                <div class="control-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <textarea name="remarks" id="remarks" class="form-control input-medium"></textarea>
