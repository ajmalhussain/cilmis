...
if ($tempstocksIssue != FALSE) {
    ...
    //to warehouse
    $whTo = $result->WHIDTo;
    $req_type=$result->requisition_type;
                    ...
                    <div class="col-md-12">
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <?php } ?>
                                <form method="POST" name="new_issue_form" id="new_issue_form" action="new_issue_action.php" enctype= "multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label class="control-label" for="req_type"> Requisition Type <span class="red">*WMS field</span> </label>
                                                    <div class="controls">
                                                        <select name="req_type" id="req_type" class="form-control input-medium" required="true" <?php if (!empty($req_type)) echo 'disabled'; ?>>
                                                            <option value="">Select</option>
                                                            <option value="requisition" <?php if ($req_type == 'requisition') echo'selected="selected"'; ?>>Requisition</option>
                                                            <option value="emergency" <?php if ($req_type == 'emergency') echo'selected="selected"'; ?>>Emergency Call</option>
                                                            <option value="expire" <?php if ($req_type == 'expire') echo'selected="selected"'; ?>>Near to expire</option>
                                                            <option value="disposal" <?php if ($req_type == 'disposal') echo'selected="selected"'; ?>>Disposal</option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label class="control-label" for="method"> Method<span class="red">*WMS field</span> </label>
                                                    <div class="controls">
                                                        <select name="method" id="method" class="form-control input-medium" required="true" <?php if (!empty($method)) echo 'disabled'; ?>>
                                                            <option value="">Select</option>
                                                            <option value="pull" <?php if ($method == 'pull') echo'selected="selected"'; ?>>Pull</option>
                                                            <option value="push" <?php if ($method == 'push') echo'selected="selected"'; ?>>Push</option> 
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label class="control-label" for="firstname"> Batch No./Lot No. <span class="red">*</span> </label>
                                                    <div class="controls">
