...
LIMIT 1";
    //query result
    $rsSql = mysql_query($strSql) or die("Error GetProduct data".$strSql);
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control input-medium" style="text-align:right" name="unit_price" id="unit_price" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
