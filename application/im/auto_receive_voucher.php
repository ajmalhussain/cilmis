                    ...
                    <div class="col-md-12">
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <form method="POST" name="batch_search" action="auto_receive_voucher.php" >
                                    <!-- Row -->
                                    <?php
                                    //get e
                                    if (isset($_GET['e'])) {
...
<?php } ?>
                                    <div class="row ">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3"> 
                                                <label for="wh_id"> Warehouse id </label>
                                                <input class="form-control" tabindex="1" id="wh_id" value="<?php echo $wh_id; ?>" name="wh_id" type="text" required />
                                            </div>
                                            <div class="col-md-3">
