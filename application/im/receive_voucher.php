...
if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) {
    ...
    $objStockMaster->WHIDTo = $_SESSION['user_warehouse'];
     $strSql = "SELECT
                ...
                WHERE
                tbl_stock_master.PkStockID = '" . $issue_no . "' AND
...
$q4 = "SELECT  DISTINCT
                                            ...
                                            tbl_stock_master.TranDate,tbl_stock_master.PkStockID 
                                    FROM
                                    tbl_stock_master
 ...
 $a='';
    if (mysql_num_rows($getStockIssues) > 0) {
        ...
        while ($resStockIssues = mysql_fetch_assoc($getStockIssues)) {
            ...
            $a .= "<td>";
            if($is_new)
                $a .= "<a href=\"../im/receive_voucher.php?issue_no=" . $resStockIssues['PkStockID'] . "&search=true\">" . $resStockIssues['TranNo'] . "</a>";
            else    
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="rec_ref" readonly id="rec_ref" type="text" class="form-control input-sm input-small" value="<?=$voucher_no?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
