...
if (isset($_POST['data']) && !empty($_POST['data'])) {
    ...
    $stock_ledger = $objStockMaster->GetStockLedgerProvLvl($district);
    //echo '<pre>';print_r($stock_ledger);exit;
    $batch_ob = $objStockMaster->getBatchOBCBProvLvl('OB', $district,$product, dateToDbFormat($date_from),$funding_source);
    $batch_cb = $objStockMaster->getBatchOBCBProvLvl('CB', $district,$product, dateToDbFormat($date_to),$funding_source);
    $batch_cb1 = $objStockMaster->getBatchOBCBProvLvl('CB', $district,$product, dateToDbFormat($date_to),$funding_source);
