                                ...
                                <table width="100%" id="myTable" cellspacing="0" align="center" class="my_custom_datatable table table-striped table-bordered table-condensed" >
                                    ...
                                    if($res && mysql_num_rows($res) > 0)
                                    {
                                        ...
                                        while($row = mysql_fetch_assoc($res))
                                        {
                                            ...
                                            if($status=='Submitted')
                                            echo ' | <a onClick="return confirm(\'Are you sure, You want to delete this Distribution Plan? This change can Not be undone.\')" href="distribution_plan_delete.php?plan_id='.$row['pk_id'].'&plan_num='.$row['plan_number'].'&redirect=distribution_plan">Delete</a>';
                                            echo '</td>';
                                            echo '</tr>';
                                        }
                                    }
