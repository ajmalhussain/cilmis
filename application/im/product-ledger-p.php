...
//                                                                {                      
                    ...
                    AND tbl_warehouse.wh_id IN (25,3912,356,3856)
                    ORDER by wh_id";
//                                                                }
//                                                                else
//                                                                {
...
//                                                                }
                                                        ...
                                                        while ($rowDist = mysql_fetch_array($rsDist)) {
                                                             if ($kpdistrict == $rowDist['wh_id']) {
                                                                $sel = "selected='selected'";
                                                                $dist_name = $rowDist['wh_name'];
                                                            } else {
                                                                $sel = "";
                                                            }
                                                            ...
                                                            ?>
                                                            <option
                                                                value="<?php echo $rowDist['wh_id']; ?>" <?php echo $sel; ?>><?php echo $rowDist['wh_name']; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
