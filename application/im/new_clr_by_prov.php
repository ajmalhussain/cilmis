...
if (isset($_POST['submit'])) {
    ...
    if ($qry['Num'] == 0) {
        ...
        if (!empty($_REQUEST['redirect_to']))
            $page = $_REQUEST['redirect_to'];
        else
            $page = 'clr_all_district_approval';
                                            ...
                                            <form name="frm" id="frm" method="post" action="">
                                                <table width="100%" id="myTable" cellspacing="0" align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php
                                                        foreach ($itemIds as $itemId) {
                                                            if (empty($SOHFieldArr[$itemId]))
                                                                $SOHFieldArr[$itemId] = 0;
                                                            if (empty($SOHDistrictArr[$itemId]))
                                                                $SOHDistrictArr[$itemId] = 0;
