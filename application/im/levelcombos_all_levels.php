...
if($_SESSION['user_stakeholder1'] == 145){
    $category='5';
    $stk_where = " AND stakeholder.stkid in (2,7,276,74,145,73,376) ";
}
...
if( $_SESSION['user_stakeholder1'] == 276){
    $category='5';
    $stk_where = " AND stakeholder.stkid in (2,7,276,74,145,376) ";
}
//page name
...
<div class="control-group col-md-12">
    ...
    <div class="col-md-2" style="display:none;" id="office-span">
        <label for="office" >Office / Level <span class="red">*</span></label>
        <div class="controls">
