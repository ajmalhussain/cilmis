...
$qry = "
    SELECT
        ...
        GROUP_CONCAT(clr_distribution_plans_stk.stk_id) as plan_stk_id
        FROM
        clr_master
        ...
        clr_master.distribution_plan_id = ".$_REQUEST['plan_id']."
            group by clr_master.pk_id,clr_details.pk_id
    ...
    $qry_itm = "SELECT
                ...
                WHERE
                        stakeholder_item.stkid in (".$dp_stk_id.")
...
$qry2 = "  SELECT
                *
                ...
                stakeholder
                WHERE
                stakeholder.stkid in (".$dp_stk_id.")  ";
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <p style="color: #000000; font-size: 25px;text-align:center">
                                                    ...
                                                    <p style="text-align:center;margin-left:35px;font-size: 12px !important;"><b><?=(isset($stk_detail)?$stk_detail:'')?> - <?php echo (!empty($province_name)?$province_name.'':'')?> </b></b></p>
