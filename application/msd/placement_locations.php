...
//include top_im
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-3"> 
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label" for="receive_no"> <?=(($is_msd_gulberg))?'Hall':'Area'?> <span class="red">*</span></label>
                                                        <div class="controls">
    ...
    ?>
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="control-group">
                                                        <label class="control-label" for="receive_no">Location Description <span class="red">*</span></label>
                                                        <div class="controls">
                                                            <input  name="place_config" autocomplete="off" id="place_config" type="text" value="" size="30" class="form-control input-medium">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="controls">
                                                            <select name="area" id="area" required class="form-control input-medium">
                                                                ...
                                                                while ($rowArea = mysql_fetch_assoc($getArea)) {
                                                                    ...
                                                                    //populate area combo
                                                                    ?>
                                                                    <option value="<?php echo $rowArea['pk_id']; ?>"><?php echo (($is_msd_gulberg)?'Hall '.$msd_val:$rowArea['list_value']); ?></option>
        <?php }
    ?>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="control-group">
                                                        <label class="control-label" for="receive_no"> <?=(($is_msd_gulberg))?'Zone':'Row'?> <span class="red">*</span></label>
                                                        <div class="controls">
                                                            <select name="row" id="row" required class="form-control input-medium">
                                                                <option value="">Select</option>
                                                                <?php
                                                                ...
                                                                while ($rowArea = mysql_fetch_assoc($getArea)) {
                                                                    ...
                                                                    $list_val = (int) --$rowArea['list_value'];
                                                                    $msd_val = $alphabet[$list_val];
                                                                    //populate row combo 
                                                                    ?>
                                                                    <option value="<?php echo $rowArea['pk_id']; ?>"><?php echo (($is_msd_gulberg)?'Zone '.$msd_val:$rowArea['list_value']); ?></option>
        <?php }
    ?>
                                                            </select>
                                                        </div>
    ...
    ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="control-group">
                                                        <label class="control-label" for="receive_no">Manual Location Name</label>
                                                        <div class="controls">
                                                            <input  name="place_config" autocomplete="off" placeholder="Leave empty for Auto Naming" id="place_config" type="text" value="" size="30" class="form-control input-medium">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="widget-body"> 
                                ...
                                <table class="dynamicTable2 table table-striped table-bordered table-condensed">
                                    ...
                                    <thead>
                                        <tr>
                                            <th> Location </th>
                                            <th><?=(($is_msd_gulberg))?'Hall':'Area'?></th>
                                            <th><?=(($is_msd_gulberg))?'Zone':'Row'?></th>
                                            <th>Rack</th>
                                            <th>Pallet</th>
                                            <th>Level</th>
                                    ...
                                    <tbody>
                                        <!-- Table row -->
                                                <?php while ($row = mysql_fetch_assoc($getPlacementLocation)) { 
                                                    ...
                                                    $loc_full_name = $row['location_name'];
                                                    if(!empty($row['loc_description'])) {
                                                        $loc_full_name = $row['loc_description'].' ('.$row['location_name'].')';
                                                    }
                                                        
                                                    
                                                    ?>
                                            <tr class="gradeX">
                                                <td nowrap><?php echo $loc_full_name  ?></td>
                                                
                                                <?php
                                                if($is_msd_gulberg){
                                                    $area_disp =  array_search($row['area'], $alphabet);
                                                    $area_disp += 1; 
                                                    $area_disp  = 'Hall '.$area_disp; 
                                                    
                                                    $list_val = (int) --$row['row'];
                                                    $row_disp = $alphabet[$list_val];
                                                    $row_disp = 'Zone '.$row_disp;
                                                }
                                                else{
                                                    $area_disp = $row['area'];
                                                    $row_disp  = $row['row'];
                                                ...
                                                <td><?php echo $area_disp ?></td>
                                                <td><?php echo $row_disp ?></td>
