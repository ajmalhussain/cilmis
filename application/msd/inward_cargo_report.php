...
//Stock Search
$result = $objStockMaster->inward_cargo_search(1, $wh_id);
//title
$title = "Stock Receive";
                    ...
                    <div class="col-md-12">
                        <div class="widget" data-toggle="collapse-widget">
                            <div class="widget-head">
                                <h3 class="heading">Inward Cargo Report - Filters</h3>
                            </div>
                        ...
                        <div class="widget" data-toggle="collapse-widget"> 
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Inward Cargo Report</h4>
                            </div>
                                        ...
                                        if ($result != FALSE) {
                                            ...
                                            while ($row = mysql_fetch_object($result)) {
                                                ...
                                                <tr class="gradeX" style="background-color:<?php echo $row->field_color; ?> !important" id="<?php echo $row->PkDetailID; ?>">
                                                    ...
                                                    <td class="text-right"><?php echo ($total_price>0)?number_format($total_price,2):'Please Update Unit Price'; ?></td>
