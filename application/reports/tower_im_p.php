                                                  ...
                                                  $qry = "SELECT
                                                        ...
                                                        FROM
                                                                (
                                                                        ...
                                                                        WHERE
                                                                                tbl_warehouse.dist_id = $sel_dist
...
//                                                        exit;
                                                        ...
                                                        <option value="<?php echo $rowItem['itm_id']; ?>" <?php echo $sel; ?>><?php echo $rowItem['itm_name']. ' ' . ((!empty($rowItem['generic_name']) && $rowItem['generic_name'] != 'NULL') ? '[' . $rowItem['generic_name'] . ']' : ''); ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: <?php echo $months_color[$value]; ?>"><?php 
                                                if($positive_stock['o_b'][$key]<0){
                                                    echo '0';
                                                }else{
                                                echo number_format($positive_stock['o_b'][$key]) ;
                                                }
                                                ?></td>
                                                <?php
                                            }
                                        ...
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: <?php echo $months_color[$value]; ?>"><?php 
                                                if($positive_stock['s_r'][$key]<0){
                                                    echo '0';
                                                }else{
                                                echo number_format($positive_stock['s_r'][$key]);
                                                }
                                                ?></td>
                                                <?php
                                            }
                                        ...
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: <?php echo $months_color[$value]; ?>"><?php 
                                                if($positive_stock['a_p'][$key]<0){
                                                    echo '0';
                                                }
                                                else{
                                                echo number_format($positive_stock['a_p'][$key]);
                                                }
                                                ?></td>
                                                <?php
                                            }
                                        ...
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: #eddada;"><b><?php  
                                                if($total_stock[$key]<0){
                                                    echo '0';
                                                }
                                                else{
                                                echo number_format($total_stock[$key]);
                                                }
                                                ?></b></td>
                                                <?php
                                            }
                                        ...
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: <?php echo $months_color[$value]; ?>"><?php
                                                if($negative_stock['issue'][$key]<0){
                                                    echo '0';
                                                }
                                                else{
                                                echo number_format($negative_stock['issue'][$key]) ;
                                                }
                                                ?></td>
                                                <?php
                                            }
                                        ...
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: <?php echo $months_color[$value]; ?>"><?php 
                                                if($negative_stock['a_n'][$key]<0){
                                                    echo '0';
                                                }else{
                                                echo number_format($negative_stock['a_n'][$key]);
                                        ...
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                                ?>
                                                <td style="background-color: #eddada;"><b><?php 
                                                if(($total_stock[$key] - $negative_total_stock[$key])<0){
                                                    echo '0';
                                                }
                                                else{
                                                echo number_format($total_stock[$key] - $negative_total_stock[$key]);
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            foreach ($months_arr as $key => $value) {
                                               ...
                                               echo number_format($amc['AMC'][$key]) ;
                                                }
                                                ?></td>
                                                <?php
                                            }
