							...
							FROM
								(
									SELECT
										...
										SUM(IF (tbl_warehouse.hf_type_id IN(4, 5), (IF (tbl_hf_data_reffered_by.hf_type_id IN(4, 5), tbl_hf_data_reffered_by.ref_surgeries, 0)),  if(itminfo_tab.itm_category=2, tbl_hf_data.issue_balance,0) )) AS surCases,
