...
//					AND tbl_hf_data.reporting_date >= '".$date_from."'
//					AND tbl_hf_data.reporting_date <= '".$date_to."'
//					ORDER BY
//						itminfo_tab.frmindex ASC";
     $query_xmlw = "SELECT
                    ...
                    AND tbl_wh_data.RptDate >= '".$date_from."'
                    AND tbl_wh_data.RptDate <= '".$date_to."'
                    ORDER BY
                                            itminfo_tab.frmindex ASC";
//    echo $query_xmlw;
//    exit();
...
//	$colType = ',ro,ro';
	...
	$csQry = "SELECT
			...
			WHERE
				tbl_hf_data.warehouse_id = ".$wh_id."
			AND tbl_hf_data.reporting_date >= ".$date_from."
			AND MONTH (tbl_hf_data.reporting_date) <= ".$date_to." ";
//        echo $csQry;
//        exit();
	//query result
