...
$where_clause .= " AND tbl_warehouse.dist_id =$dist ";
...
<div class="row">
    <div class="col-md-12">
        <table width="100%" cellpadding="0" cellspacing="0" id="myTable" class="table table-bordered table-condensed">
            <tr>
                <td align="center" width="95%"   ><h3 class="text-info">Compliance Report - Health Facility Wise - <?= $province_name ?> - <?= $stk_name ?></h3></td>
