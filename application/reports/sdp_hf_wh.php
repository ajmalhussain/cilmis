...
//        $where_consum = "HAVING soh = 0";
//    } elseif ($consumption == 2) {
//        $where_consum = "HAVING consum = 0 AND soh = 0";
//    }
    //Getting warehouse
                                                ...
                                                <!--                                                <div class="col-md-2" style="text-align:left;">
                                                                                                    <div class="form-group" >
                                                                                                        ...
                                                                                                        <select name="consum" id="consum" class="form-control input-sm" required="true">
                                                                                                            <option value="2" <?php if ($consumption == 2) echo 'selected=selected' ?>>SOH=0 AND Consumption=0</option>
                                                                                                            <option value="0"  <?php if ($consumption == 0) echo 'selected=selected' ?>>Consumption = 0</option>
                                                                                                            <option value="1" <?php if ($consumption == 1) echo 'selected=selected' ?> >SOH = 0</option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                </div>-->
...
FROM
	tbl_warehouse
INNER JOIN stakeholder off ON tbl_warehouse.stkofficeid = off.stkid
...
WHERE
	tbl_warehouse.wh_id NOT IN (
		...
		WHERE
			tbl_hf_data.reporting_date BETWEEN '$dateFrom-01' AND '$dateTo-01'
		$where_stk
		$where_prov
	)
AND off.lvl = 7
...
$where_dist";
                    ...
                    if ($numnr > 0) {
                        ...
                        <div class="widget">
                            <div class="widget-body">
                                <div class="widget-head">
                                    <h5>Facilities list not reporting from <?php echo $dateFrom . " to " . $dateTo; ?></h5>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <table style="width:95%;margin-left: 2%;" align="center"   id="myTable" class="table table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                <?php
                                                $counternr = 1;
                                                while ($rownr = mysql_fetch_assoc($resnr)) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $counternr; ?></td>
                                                        <td><?php echo $rownr['Stakeholder']; ?></td>
                                                        <td><?php echo $rownr['Province']; ?></td>
                                                        <td><?php echo $rownr['District']; ?></td>
                                                        <td><?php echo $rownr['wh_name']; ?></td>
                                                        <td><?php echo $rownr['Status']; ?></td>
                                                    </tr>
                                                    <?php
                                                    $counternr++;
                                                }
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="widget-head">
                            <h5>Facilities list with zero consumption reporting from <?php echo $dateFrom . " to " . $dateTo; ?></h5>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12 right">
                                        <img src="<?php echo PUBLIC_URL; ?>images/excel-16.png" onClick="tableToExcel('export3', 'sheet 1', '<?php echo $fileName; ?>')" alt="Excel" style="cursor:pointer;" />
                                    </div>
                                </div>
                                <div class="row" id="export3">
                                    <div class="row"><br></div>
                                    <?php
...
tbl_hf_data.reporting_date BETWEEN '$dateFrom-01' AND '$dateTo-01' $where_prov $where_dist $where_stk $where_prod
			...
			WHERE
				warehouse_status_history.reporting_month BETWEEN '$dateFrom-01'
			AND '$dateTo-01'
...
//                                   exit;
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="widget-head">
                            <h5>Facilities list with zero stock on hand reporting from <?php echo $dateFrom . " to " . $dateTo; ?></h5>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12 right">
                                        <img src="<?php echo PUBLIC_URL; ?>images/excel-16.png" onClick="tableToExcel('export2', 'sheet 1', '<?php echo $fileName; ?>')" alt="Excel" style="cursor:pointer;" />
                                    </div>
                                </div>
                                <div class="row" id="export2">
                                    <div class="row"><br></div>
                                    <?php
                                    $prod_array = $wh_array = $test_array = array();
                                    $qry = "SELECT
...
//                                   exit;
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="widget-head">
                            <h5>Facilities list with zero stock on hand and zero consumption reporting from <?php echo $dateFrom . " to " . $dateTo; ?></h5>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12 right">
                                        <img src="<?php echo PUBLIC_URL; ?>images/excel-16.png" onClick="tableToExcel('export1', 'sheet 1', '<?php echo $fileName; ?>')" alt="Excel" style="cursor:pointer;" />
                                    </div>
                                </div>
                                <div class="row" id="export1">
                                    <div class="row"><br></div>
                                    <?php
                                    $prod_array = $wh_array = $test_array = array();
                                    $qry = "SELECT
