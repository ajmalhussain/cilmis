        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h4>Stock <?php echo $operatorvalue; ?> in SDPs: <?php echo (--$count); ?></h4>
                    </div>
                    <div class="col-md-4">
                        <h4>Stock <?php echo $operatorvalue; ?> rate: <?php echo ROUND((--$count)/$totalcnt*100,2); ?>%</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
