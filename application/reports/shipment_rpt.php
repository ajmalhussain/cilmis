...
if($_SESSION['user_stakeholder'] == '1222')
{
    $pid2 = "AND stakeholder.ParentID = '".$_SESSION['user_stakeholder']."'";
}
else 
{
    $pid2 = "AND stakeholder.stkid = 1";
}

if($_SESSION['user_stakeholder'] == '1222')
{
//    $stkofficeid1 = "AND stkofficeid = '1223'";
}

if($_SESSION['user_stakeholder'] == '1222')
{
    $parentid = "AND stakeholder.ParentID = '".$_SESSION['user_stakeholder']."'";
}

if($_SESSION['user_stakeholder'] == '1222')
{
    $pid1 = "AND stakeholder.ParentID = '".$_SESSION['user_stakeholder']."'";
}
else 
{
    $pid1 = "AND stakeholder.stkid = '".$_SESSION['user_stakeholder']."'";
}
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="wh_type" id="wh_type" class="form-control input-sm">
                                                           <?php if($_SESSION['user_stakeholder'] == '1222')
                                                           { ?> 
                                                            <option value="1" <?php echo ($whType == 1) ? 'selected="selected"' : ''; ?>>Federal</option>
                                                            <?php } else { ?>
