...
<script>
    ...
    function doInitGrid() {
        ...
        mygrid.attachHeader("<div style='text-align:center;'>Product</div>,<div style='text-align:center;'>Generic Name</span>,<div style='text-align:center;'>Batch No</span>,<div style='text-align:center;'>Opening Balance</span>,<span title='Balance received'>Received</span>,<span title='Balance issued'>Issued</span>,<div style='text-align:center;'>Adjustments</div>,#cspan,<span title='Closing balance'>Closing Balance</span><?php echo $header; ?>,<span title='Last Modified'>Last Modified</span>");
...
<?php } ?>
        mygrid.setInitWidths("*,120,100,100,100,100,60,60,120<?php echo $width; ?>,120");
