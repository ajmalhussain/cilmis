    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">District Wise</h3>
                                                    ...
                                                    <div class="controls">
                                                        <select name="stk_sel" id="stk_sel"  class="form-control input-sm" required>
                                                            ...
                                                            while ($rowstk = mysql_fetch_array($rsstk)) {
                                                                ...
                                                                if ($_SESSION['user_stakeholder'] == $rowstk['stkid']) {
                                                                     $sel = "selected='selected'";
        ...
        if(isset($_REQUEST['submit'])){
            if($rep_level=='7')
                include "compliance_inc_sdp_im_kp.php";
            else
                include "compliance_inc_dist_stores_kp.php";
            }
        ?>
            </div>
        </div>
