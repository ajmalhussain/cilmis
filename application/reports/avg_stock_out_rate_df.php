...
//query result
                ...
                stakeholder_item.stk_item as itm,
                    ...
                    stats_tab_reporting_rate.reporting_month
                FROM
                ...
                WHERE
                   ...
                   $where_clause
                   AND stakeholder_item.stk_item IN ($itm)
                ...
                GROUP BY
                    ...
                    $disabled_qry = "
                                                SELECT
                                                GROUP_CONCAT(DISTINCT warehouse_status_history.warehouse_id) twh,
                    ...
                    /*if(in_array(7,$stk)){
                        ...
                        $ifnotshf = " AND tbl_warehouse.wh_id NOT IN (" . implode(',', $disabled_wh) . ") ";
                    }*/
                                                    ...
                                                    foreach ($itm_arr as $itm_id => $itm_name) {
                                                        ...
                                                        foreach ($months_list as $k => $v) {
                                                            ...
                                                            if (isset($dorment_facility[$prov_id][$itm_id]) && !empty($dorment_facility[$prov_id][$itm_id])) {
                                                                ...
                                                                $master_total = $master_total+$dorment_facility[$prov_id][$itm_id];
                                                            }
