...
if (isset($_REQUEST['distId']) && !empty($_REQUEST['distId']) ) {
    //get warehouse id
...
elseif (empty($_REQUEST['distId']) && isset($_REQUEST['provId'])) {
    //get warehouse id
    $whId = (!empty($_REQUEST['whId'])) ? $_REQUEST['whId'] : '';
    //get stakeholder id
    $stkId = $_REQUEST['stkId'];
...
elseif (empty($_REQUEST['provId']) && empty($_REQUEST['distId'])) {
    //get warehouse id
    $whId = (!empty($_REQUEST['whId'])) ? $_REQUEST['whId'] : '';
    //get stakeholder id
    $stkId = $_REQUEST['stkId'];
