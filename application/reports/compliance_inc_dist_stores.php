...
$dist_store_id = $_SESSION['user_district'];
//print_r($wh);exit;
$filter='';
if ($rep_level==3){
...
//print_r($selPro);exit;
        ...
        $qry_1 = "  
            SELECT
                ...
                AND tbl_warehouse.dist_id=$dist_store_id
                AND tbl_warehouse.is_allowed_im = 1
...
//            echo '<pre>';print_r($total_dist);exit;
            ...
            $qry = "SELECT
                ...
                AND tbl_warehouse.prov_id = ".$_SESSION['user_province']."
                GROUP BY
                        tbl_warehouse.wh_id,
                        tbl_warehouse.stkid,
                        tbl_wh_data.RptDate
