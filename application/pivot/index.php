                ...
                <div class="row">
                    <div class="widget" id="printing">
                        ...
                        <div class="widget-body">
                            ...
                            <script type="text/javascript">
                                $(function() {
                                    ...
                                    var parseAndPivot = function(f) {
                                        ...
                                        //                                                }
                                        //                                            });
                                        $.getJSON("summary.php", function(mps) {
                                            $("#output").pivotUI(mps, {
                                                renderers: renderers
                                            });
                                        });
                                ...
                                function exportTableToExcel(tableID, filename = '') {
                                    ...
                                    var tableSelect = document.getElementById(tableID).textContent;
                                    alert(tableSelect);
                            ...
                            <input type='button' onclick='exportTableToExcel("outputt","Page");' value='Export to Excel' />
