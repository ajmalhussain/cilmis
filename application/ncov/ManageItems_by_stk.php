...
<?php if ($_SESSION['user_id'] == 10201) { ?>
                                                            <select name="txtStkName4" id="txtStkName4" class="form-control input-medium">
                                                                <option value="16" >Consumables - Supplies</option>
                                                                <option value="17" >Consumables - Equipments</option>
                                                                <option value="18" >Non Consumables - Supplies</option>
                                                                <option value="19" >Non Consumables - Equipments</option>       
                                                            </select>
<?php } else { ?>
                                                            <select name="txtStkName4" id="txtStkName4" class="form-control input-medium">
                                                                <option value="13" >Set A</option>
                                                                <option value="14" >Set B</option>
                                                                <option value="15" >Set C</option>        
                                                            </select>
<?php } ?>
                                                    </div>
                                                </div>
