                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input class="form-control input-medium"  id="d_contact" name="d_contact" type="text" value="<?php echo ""; ?>" <?php if (!empty($TranRef)) { ?>disabled="" <?php } ?>/>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input class="form-control input-medium"  id="d_cnic" name="d_cnic" type="text" value="<?php echo ""; ?>" <?php if (!empty($TranRef)) { ?>disabled="" <?php } ?>/>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                            </div>
