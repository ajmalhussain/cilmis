...
//get warehouse	
    ...
    header("location:" . APP_URL . "dsc/issue.php?warehouse=1");
...
if(!empty($_REQUEST['ref_page']))
    header("location:" . APP_URL . "dsc/".$_REQUEST['ref_page'].".php");
else
    header("location:" . APP_URL . "dsc/distribution_plan_district_level.php");
