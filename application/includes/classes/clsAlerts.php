...
class clsAlerts {
    ...
    public function count_shipment_alerts() {
        ...
        if(isset($_SESSION['user_warehouse']))
            $and .= " AND shipments.wh_id = ".$_SESSION['user_warehouse']." ";
    ...
    public function count_po_alerts() {
        $and= "";
       
        if(isset($_SESSION['user_warehouse']))
            $and .= " AND purchase_order.wh_id = ".$_SESSION['user_warehouse']." ";
...
WHERE TO_DAYS(contract_delivery_date) - TO_DAYS(NOW()) between -30 and 30
...
purchase_order.pk_id,
TO_DAYS(contract_delivery_date) - TO_DAYS(NOW()) as delivering_in_days,
...
WHERE TO_DAYS(contract_delivery_date) - TO_DAYS(NOW()) between -30 and 30
                                ...
                                ".$and." 
                                    ORDER BY contract_delivery_date";
       $qryRes = mysql_query($qry);
        return $qryRes;
    }
