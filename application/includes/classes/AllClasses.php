...
if(!empty($_SERVER['REQUEST_URI']) )
{
    ...
    $file_a = end($uri_a); 
//    echo $file_a;exit;
    if( $file_a == 'tower.php' || $file_a == 'dashboard_fp2020.php'){
...
require_once("clsPurchaseOrderDetails.php");
require_once("clsPurchaseOrderProductDetails.php");
...
require_once("clsShipments.php");
require_once("clsComments.php");
...
//creatting object of clsHealthFacilityType
$objshipments = new clsShipments();
$objcomments = new clsComments();
$objAlerts= new clsAlerts();
$objPurchaseOrder= new clsPurchaseOrder();
$objPurchaseOrderDetails= new clsPurchaseOrderDetails();
$objPurchaseOrderProductDetails=new clsPurchaseOrderProductDetails();