...
<html><?php include("menu.php"); ?>
    <h3 align="center">(8) Closing Balance Calculations  :  <span style="color:green">(OB + R - I + Adj_a - Adj_b = CB )   tbl_wh_data(lvl)</span></h3>
    <body>
...
INNER JOIN stakeholder ON tbl_warehouse.stkofficeid = stakeholder.stkid
                        WHERE
                             tbl_wh_data.RptDate = '$date_start' 
                   ...
                   //inserting log in mismatches table...
                    if( (int)$calc!=(int)$cb)
                    {
                        ...
                        $del="DELETE FROM data_mismatches WHERE "
                                . " match_type = 'cb_calc' AND  "
                                . " district = '".$row['dist_id']."' AND "
                        ...
                        $ins = "INSERT INTO `data_mismatches` 
                                ...
                                VALUES 
                                ( 'cb_calc', '".$itm_data['province']."', '".$dist."', NULL, '".$date."', '', '".$itm_id."', 
                                 'tbl_hf_data', 'tbl_hf_type_data', '".$cb."', '".$calc."', NULL, NULL, 'MISMATCH');";
                        mysql_query($ins);
                    }
