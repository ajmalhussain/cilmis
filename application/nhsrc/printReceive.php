...
//include header
    ...
    <table id="myTable" class="table-condensed">
        <tr>
            ...
            <td width="16%"><b>Pack Size</b></td>
            <td align="center"><b>Packs/Cartons</b></td>
        </tr>
        <tbody>
            <?php
            $i = 0;
            ...
            if (!empty($receiveArr)) {
                foreach ($receiveArr as $val) {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"> <?php $wrd= "PPE"; if(strpos($val->itm_name, $wrd) !== false) { echo "NA"; } else { ?><?php echo date("d/m/y", strtotime($val->batch_expiry)); } ?></td>
                        <td style="text-align:right;"><?php echo number_format($val->Qty); ?></td>
                        <td style="text-align:right;"><?php echo $val->UnitType; ?></td>
                        <td style="text-align:right;"><?php echo $val->quantity_per_pack; ?></td>
