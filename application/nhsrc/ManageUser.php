...
<body class="page-header-fixed page-quick-sidebar-over-content" <?=($strDo!='Edit'?'onLoad="doInitGrid()"':'')?>>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-5">
                                                <div class="control-group">
                                                    ...
                                                    <input required="required" value="" name="user_password" id="user_password" type="text" />
                                                        <?php
                                                        //echo '<pre>';print_r($RowEditStk);exit;
                                                        ?>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div style="height:200px;overflow:scroll;" id="districts"> </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div style="height:200px;overflow:scroll;" id="Warehouses1"></div>
    ...
    <script>
        ...
        function doInitGrid() {
            ...
            mygrid.setHeader("<span title='Serial Number'>Sr. No.</span>,<span title='Stakeholder'>Stakeholder</span>,<span title='Province'>Province</span>,<span title='District'>District</span>,<span title='Warehouses Assigned'>Warehouses Assigned</span>,<span title='Username'>Username</span>,<span title='Role'>Role</span>,<span title='Use this column to perform the desired operation'>Actions</span>,#cspan,#cspan");
            mygrid.attachHeader(",#select_filter,#select_filter,#text_filter,#text_filter,#text_filter,#select_filter,Edit User,Change Password,Enable / Disable");
            mygrid.setInitWidths("30,70,70,70,*,110,90,50,50,50");
