...
//Stock Issue Search
$result = $objStockMaster->distribution_report_search(2, $wh_id);
                    ...
                    <div class="col-md-12">
                        <div class="widget" data-toggle="collapse-widget">
                            <div class="widget-head">
                                <h3 class="heading">Distribution Report</h3>
                            </div>
                        ...
                        <div class="widget" data-toggle="collapse-widget">
                            <div class="widget-head">
                                <h3 class="heading">Stock Distribution Report</h3>
                            </div>
                            <!-- // Widget heading END -->
...
//                                echo $b['batch_no']; 
                                ...
                                $gp = '';
                                if(!empty($row->gate_passes)){
                                    $g_p = explode(',',$row->gate_passes);
                                    $g_i = explode(',',$row->gate_pass_id);
                                    foreach($g_i as $k=>$g){
                                         $gp .= '<a onClick="window.open(\'printGatePass.php?id='.$g.'\', \'_blank\', \'scrollbars=1,width=842,height=595\');" href="javascript:void(0);">'.$g_p[$k].'</a></br>';
                                ...
                                ?>
                                                    ...
                                                    <td><?php echo $gp; ?></td>
                                                    <td><?php echo str_replace(',','</br>',$row->vehicles); ?></td>
                                ...
                                <div class="note note-info">
                                    NOTE: <br>Vouchers issued to facilities can be deleted until they are marked as received by the receiver. <br>Those vouchers which are issued to Health Facilities having NO inventory management , will also remain available for deletion. 
                                    <br><br>
                                    support@lmis.gov.pk
                                </div>
                            </div>
