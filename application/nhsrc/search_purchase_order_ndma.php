...
$result = $objshipments->NDMAShipmentSearch(1, $wh_id,$gp_by);
//title
$title = "Shipments";
...
if(isset($_SESSION['user_level']) && $_SESSION['user_level'] == 2) {
    ...
    if(isset($_SESSION['user_stakeholder1'])) {
        $where1 .= " AND funding_stk_prov.stakeholder_id = ".$stk_id." ";
    }
} else {
...
$strSql2 = "
        ...
        WHERE
                ...
                tbl_stock_master.CreatedBy = " . $user_id . " AND 
                tbl_stock_master.TranTypeID = 1
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label class="control-label" for="receive_date"> PO Date / Delivery Date</label>
                                                    <div class="controls">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="controls">
                                                    <select name="status" id="status" required="true" class="form-control input-medium">
                                                        ...
                                                        <option <?=(($status=='PO')?' selected ':'')?> value="PO"> Purchase Order </option>
                                                    </select>
                                                </div>
                                            </div>
