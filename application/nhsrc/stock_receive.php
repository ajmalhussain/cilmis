                                        ...
                                        if ($result != FALSE) {
                                            ...
                                            while ($row = mysql_fetch_object($result)) {
                                                ...
                                                <tr class="gradeX" style="background-color:<?php echo $row->field_color; ?> !important" id="<?php echo $row->PkDetailID; ?>">
                                                    ...
                                                    <td><?php echo (!empty($row->UnitType)?$row->UnitType:''); ?></td>
                                                    <td width="8%"><?php $wrd= "PPE"; if(strpos($row->itm_name, $wrd) !== false) { echo "NA"; } else { ?><?php echo date("d-M-y", strtotime($row->batch_expiry)); } ?></td>     
