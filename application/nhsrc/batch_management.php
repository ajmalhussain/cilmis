                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget" data-toggle="collapse-widget">
                            ...
                            <div class="widget-body"> 
                                        ...
                                        if (!empty($data) && mysql_num_rows($data) > 0) {
                                            ...
                                            while ($row = mysql_fetch_object($data)) {
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td><?php echo $row->itm_name.(!empty($row->generic_name)?' ['.$row->generic_name.']':''); ?></td>
                                ...
                                <div style="clear:both"></div>
                                <p style="color:red">Note: Single batch# supplied by different funders, has funding source as suffix in bracket like B-1010 (ADB)</p>
                            </div>
                        </div>
                    </div>
