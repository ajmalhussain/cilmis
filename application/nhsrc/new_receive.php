...
//query result
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $row_xmlw['wh_id'];?>" <?php if ($from_id == $row_xmlw['wh_id']) { ?> selected="" <?php } ?>> <?php echo $row_xmlw['wh_name'];?> </option>
                                                        <?php } ?>
                                                    </select>
                                            ...
                                            <div class="col-md-1" style="margin-top: 30px;" >
                                                <a class="btn btn-xs green " href="../nhsrc/ManageItems_by_stk.php" target="_blank" ><i class="fa fa-plus"></i></a></div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="col-md-6">
                                                    <label class="control-label" for="manufacturer"> Manufacturer/Supplier <span class="red">*</span> </label>
                                                    <div class="controls">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <label class="control-label" for="batch"> Batch/Lot No <span class="red">*</span> </label>
                                                <div class="controls">
                                            ...
                                            <div class="col-md-3" id="expiry_div">
                                                <label class="control-label" for="expiry_date"> Expiry date <span class="red" title="If NA, select Maximum available date as expiry"><i class="info"></i>*</span>  </label>
                                                <div class="controls">
                                            ...
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    <label class="control-label" for="coversion_rate">
                                                        Dollar Conversion Rate
                                                    </label>
                                                    <div class="controls">
                                                        <input class="form-control input-medium" id="dollar_rate" name="dollar_rate" type="text" value="150"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <br>Unit Price (PKR): <span id="unit_price_pkr"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <label class="control-label" for="amount_dollar"> Amount ($) </label>
                                                <div class="controls">
                                                    <input type="text" class="form-control input-medium" name="amount_dollar" id="amount_dollar" autocomplete="off" readonly="" />

                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="control-label" for="amount_pkr"> Amount (PKR) </label>
                                                <div class="controls">
                                                    <input type="text" class="form-control input-medium" name="amount_pkr" id="amount_pkr" autocomplete="off" readonly="" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                                ...
                                                <textarea name="remarks" id="remarks" maxlength="600" style="resize:none;" class="form-control"><?php echo $ReceivedRemarks; ?></textarea>
                                            </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="modal-body">
                                        <form name="addnew" id="addnew" action="add_action_manufacturer.php" method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-6">
                                                        <label class="control-label">Manufacturer/Supplier<span class="red">*</span></label>
                                                        <div class="controls">
